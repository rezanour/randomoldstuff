...
namespace GDK
{
    ...
    public:
        ...
        void            SetRight(_In_ const Vector3& value);
        void            SetUp(_In_ const Vector3& value);
        void            SetForward(_In_ const Vector3& value);
        void            SetTranslation(_In_ const Vector3& value);
        ...
        // transforms a normal. this computes the inverse-transpose of the matrix and uses that
        static Vector3  TransformNormal(const Vector3& normal, const Matrix& m);
        // transforms a normal. You are providing an inverseTranspose already
        static Vector3  TransformNormalUsingIT(const Vector3& normal, const Matrix& it);
        ...
        static Matrix   Adjunct(const Matrix& m);
