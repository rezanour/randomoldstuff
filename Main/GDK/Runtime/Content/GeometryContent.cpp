...
namespace GDK
{
    ...
    // [Vertices Data Buffer ] (byte_t*) for each element
    ...
    {
        return std::shared_ptr<GeometryContent>(GDKNEW GeometryContent(numAttributes, attributes, vertexStride, numVertices, vertices, numIndices, indices, numFrames, numAnimations, animations));
    }
    ...
    std::shared_ptr<GeometryContent> GeometryContent::Create(_Inout_ std::istream &stream)
    {
        ...
        std::unique_ptr<byte_t[]> vertices(new byte_t[header.VertexStride * header.VertexCount]);
        ...
        return std::shared_ptr<GeometryContent>(GDKNEW GeometryContent(header.AttributeCount, attributes, header.VertexStride, header.VertexCount, vertices, header.IndexCount, indices, header.FrameCount, header.AnimationCount, animations));
    }
    ...
    const byte_t* GeometryContent::GetAttributeData(_In_ GeometryContent::AttributeType type, _In_ GeometryContent::AttributeName name, _In_ byte_t semanticIndex) const
    {
    ...
    const byte_t* GeometryContent::GetVertices() const
    {
