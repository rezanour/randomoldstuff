...
public:
    ...
    virtual ~MainFrame();    
    ContentPreviewPane* GetContentPreviewPane() { return &_contentPreviewPane; }
    ContentPane* GetContentPane() { return &_contentPane; }
    void EnterRunGameMode();
    void ExitRunGameMode();
    bool IsGameRunning() {return _runGameMode;};
...
protected:
    ...
    ContentPreviewPane  _contentPreviewPane;
    bool _runGameMode;
