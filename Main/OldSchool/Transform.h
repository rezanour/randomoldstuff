...
public:
    ...
    void Move(_In_ const XMVECTOR& movement);

    void Rotate(_In_ const XMFLOAT3& axis, _In_ float angle);
    void Rotate(_In_ const XMVECTOR& axis, _In_ float angle);
    ...
    void AlignUp(_In_ const XMFLOAT3& axis);
    void AlignUp(_In_ const XMVECTOR& axis);
