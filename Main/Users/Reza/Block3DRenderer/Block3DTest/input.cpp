...
bool Input::IsQuitButtonPressed() const
{
    return IsKeyJustPressed(VK_ESCAPE);
}

bool Input::IsActionButtonPressed() const
{
    return IsKeyJustPressed(VK_SPACE);
}

bool Input::IsRunButtonDown() const
{
