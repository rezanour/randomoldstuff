...
static short g_playerX;
static short g_playerY;
...
static unsigned short map[4096];
...
int WINAPI WinMain(HINSTANCE instance, HINSTANCE prevInstance, LPSTR commandLine, int showCommand)
{
    ...
    while (msg.message != WM_QUIT)
    {
        ...
        else
        {
            ...
            RastView3D(g_playerX, g_playerY, ANG_90);
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_KEYDOWN:
        ...
        case VK_DOWN:
            g_playerY++;
            if (g_playerY > NUM_CELLS << CELL_SIZE_SHIFT) g_playerY = NUM_CELLS << CELL_SIZE_SHIFT;
            break;
        ...
        case VK_RIGHT:
            g_playerX++;
            if (g_playerX > NUM_CELLS << CELL_SIZE_SHIFT) g_playerX = NUM_CELLS << CELL_SIZE_SHIFT;
            break;
        }
        break;
    }
