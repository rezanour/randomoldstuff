...
namespace Lucid3D
{
    ...
    class BaseShader : public GDK::RefCountedBase<GDK::IRefCounted>
    {
    public:
        virtual ~BaseShader();

        GDK_METHOD Initialize(_In_ Renderer* pRenderer) = 0;
        ...
        GDK_METHOD RenderBatch(_In_ ContextPtr& spContext, _In_ CameraPtr& spCamera, _In_ std::vector<std::shared_ptr<RenderTask>>& renderTasks) = 0;
