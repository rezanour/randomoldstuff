...
public:
    ...
    HRESULT DrawDropShadowedTextLine(const WCHAR* strMsg);
    void End();
...
class CDXUTSpriteHelper
{
public:
    CDXUTSpriteHelper( ID3D11Device* pd3d11Device, ID3D11DeviceContext* pd3dDeviceContext, CDXUTDialogResourceManager* pManager, const WCHAR* strTexture );
    ~CDXUTSpriteHelper();

    void SetForegroundColor( D3DXCOLOR clr ) { m_clr = clr; }
    void Begin();
    HRESULT DrawSprite( RECT& rc, DWORD dwFlags);
    void End();
