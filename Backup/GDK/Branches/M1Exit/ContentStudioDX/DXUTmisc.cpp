...
LPDXUTCALLBACKDEBUGPRINT g_DebugPrintCallback = NULL;
void* g_DebugPrintCallbackContext = NULL;

void DXUTSetDebugPrintCallback(LPDXUTCALLBACKDEBUGPRINT pCallback, void* pContext)
{
    g_DebugPrintCallback = pCallback;
    g_DebugPrintCallbackContext = pContext;
}
...
void __cdecl dxutodprintf(const char *format, ...)
{
    ...
    *p   = '\0';
    ...
    if (g_DebugPrintCallback != NULL)
    {
        g_DebugPrintCallback(buf, g_DebugPrintCallbackContext);
    }
}
