...
{
    L3DMath::Vector3 Position;
    L3DMath::Vector3 Normal;
    L3DMath::Vector3 Tangent;
    L3DMath::Vector3 Bitangent;
    L3DMath::Vector4 Color;
    L3DMath::Vector2 TextureCoord0;
    L3DMath::Vector2 TextureCoord1;
    L3DMath::Vector2 TextureCoord2;
    L3DMath::Vector2 TextureCoord3;
    L3DMath::Vector4 BoneIndices;
    L3DMath::Vector4 BoneWeights;
};
...
struct IGeometryResource : public IUnknown
{
    ...
    virtual HRESULT SetColor(_In_ L3DMath::Vector4 color) = 0;
