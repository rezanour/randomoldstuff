...
BOOL CContentStudioDoc::OnNewDocument()
{
    ...
    if (m_firstDocument)
    {
        m_firstDocument = false;
        return TRUE;
    }
    return (SUCCEEDED(CreateDocument()));
}
...
void CContentStudioDoc::WriteFileProperties(CFileNode* pNode, IContentStudioProperties* pNodeProperties, IContentStudioProperties* pParentProperties)
{
    ...
    //std::wstring id = FileFromFilePath(pNode->fullPath.c_str(), FALSE);
    //pNodeProperties->SetStringW(IdProperty, (LPWSTR)id.c_str());
    
    //std::wstring parentId = ReadStringPropertyW(IdProperty, pParentProperties);
    //pNodeProperties->SetStringW(ParentIdProperty, (LPWSTR)parentId.c_str());
...
void CContentStudioDoc::WriteGameObjectProperties(CFileNode* pNode, IContentStudioProperties* pNodeProperties)
{
    ...
    pNodeProperties->SetInt32("ContentType", (int)GDK::ContentType::ObjectContent);
    pNodeProperties->SetInt32("ContentSubType", (int)GDK::ObjectType::GameObjectInstanceObject);
}
...
void CContentStudioDoc::WriteVisualComponentProperties(CFileNode* pNode, IContentStudioProperties* pNodeProperties)
{
    ...
    pNodeProperties->SetString(IdProperty, (LPSTR)file->GetStringValue(IdProperty).c_str());
    pNodeProperties->SetInt32("ContentType", (int)GDK::ContentType::ComponentContent);
    pNodeProperties->SetInt32("ContentSubType", (int)GDK::ComponentType::VisualComponent);
}
...
void CContentStudioDoc::WriteLightComponentProperties(CFileNode* pNode, IContentStudioProperties* pNodeProperties)
{
    ...
    pNodeProperties->SetString(IdProperty, (LPSTR)file->GetStringValue(IdProperty).c_str());
    pNodeProperties->SetInt32("ContentType", (int)GDK::ContentType::ComponentContent);
    pNodeProperties->SetInt32("ContentSubType", (int)GDK::ComponentType::LightComponent);
}
...
void CContentStudioDoc::WriteCameraComponentProperties(CFileNode* pNode, IContentStudioProperties* pNodeProperties)
{
    ...
    pNodeProperties->SetString(IdProperty, (LPSTR)file->GetStringValue(IdProperty).c_str());
    pNodeProperties->SetInt32("ContentType", (int)GDK::ContentType::ComponentContent);
    pNodeProperties->SetInt32("ContentSubType", (int)GDK::ComponentType::CameraComponent);
}
...
void CContentStudioDoc::WriteModelAssetProperties(CFileNode* pNode, IContentStudioProperties* pNodeProperties)
{
    ...
    pNodeProperties->SetString(IdProperty, (LPSTR)file->GetStringValue(IdProperty).c_str());
    pNodeProperties->SetInt32("ContentType", (int)GDK::ContentType::AssetContent);
    pNodeProperties->SetInt32("ContentSubType", (int)GDK::AssetType::StaticModelAsset);
}
...
void CContentStudioDoc::WriteMaterialAssetProperties(CFileNode* pNode, IContentStudioProperties* pNodeProperties)
{
    ...
    pNodeProperties->SetString(IdProperty, (LPSTR)file->GetStringValue(IdProperty).c_str());
    pNodeProperties->SetInt32("ContentType", (int)GDK::ContentType::AssetContent);
    pNodeProperties->SetInt32("ContentSubType", (int)GDK::AssetType::MaterialAsset);
}
...
void CContentStudioDoc::WriteScreenProperties(CFileNode* pNode, IContentStudioProperties* pNodeProperties)
{
    ...
    pNodeProperties->SetString(IdProperty, (LPSTR)file->GetStringValue(IdProperty).c_str());
    pNodeProperties->SetInt32("ContentType", (int)GDK::ContentType::ObjectContent);
    pNodeProperties->SetInt32("ContentSubType", (int)GDK::ObjectType::ScreenObject);
}
...
void CContentStudioDoc::WriteTextureResourceProperties(CFileNode* pNode, IContentStudioProperties* pNodeProperties)
{
    ...
    if (SUCCEEDED(hr))
    {
        ...
        pNodeProperties->SetInt32("ArraySize", (int)trf.metadata.arraySize);
        pNodeProperties->SetInt32("Depth", (int)trf.metadata.depth);
        pNodeProperties->SetInt32("MipLevels", (int)trf.metadata.mipLevels);
        pNodeProperties->SetInt32("Misc", (int)trf.metadata.miscFlags);
        pNodeProperties->SetInt32("Dimension", (int)trf.metadata.dimension);
    }

    pNodeProperties->SetInt32("ContentType", (int)GDK::ContentType::ResourceContent);
    pNodeProperties->SetInt32("ContentSubType", (int)GDK::ResourceType::Texture2DResource);
}
...
void CContentStudioDoc::WriteGeometryResourceProperties(CFileNode* pNode, IContentStudioProperties* pNodeProperties)
{
    ...
    if (SUCCEEDED(hr))
    {
        ...
        pNodeProperties->SetInt32("Indices", (int)grf.IndicesCount);
        pNodeProperties->SetInt32("Vertices", (int)grf.VertexCount);
    }

    pNodeProperties->SetInt32("ContentType", (int)GDK::ContentType::ResourceContent);
    pNodeProperties->SetInt32("ContentSubType", (int)GDK::ResourceType::GeometryResource);
}
...
void CContentStudioDoc::WriteContentIndexEntry( IContentStudioProperties* pNodeProperties)
{
    if ((pNodeProperties != nullptr) && (_contentIndex != nullptr))
    {
        ...
        if (!id.empty())
        {
            ...
            std::string ct = ReadStringProperty("ContentType", pNodeProperties);
            std::string cst = ReadStringProperty("ContentSubType", pNodeProperties);
...
HRESULT CContentStudioDoc::DebugCreateCubeOnPlaneProject(bool useWolfenstein3dMap)
{
    ...
    cubeMaterialAsset->SetValue<int>("MaterialId", 0);
    cubeMaterialAsset->SetValue<uint64>("Diffuse", cubeTextureResourceId);
    ...
    cubeModelAsset->SetStringValue("NumMeshes", "1");
    ...
    cubeVisualComponent->SetValue<uint64>("Model", cubeModelAssetId);
    ...
    cubeGameObject->SetValue<GDK::Transform>("Transform", transform);
    cubeGameObject->SetValue<uint64>("VisualComponent", visualComponentId);
    ...
    cameraComponent->SetStringValue("CameraType", "Perspective");
    cameraComponent->SetStringValue("Fov", "60");
    cameraComponent->SetStringValue("Near", "0.1");
    cameraComponent->SetStringValue("Far", "100.0");
    ...
    cameraGameObject->SetValue<GDK::Transform>("Transform", transform);
    cameraGameObject->SetValue<uint64>("CameraComponent", cameraComponentId);
    ...
    lightComponent->SetStringValue("LightType", "Directional");
    lightComponent->SetStringValue("Color", "1.0, 1.0, 1.0");
    ...
    DirectX::XMStoreFloat4(&transform.Orientation, DirectX::XMQuaternionRotationMatrix(lightWorld));
    ...
    lightGameObject->SetValue<GDK::Transform>("Transform", transform);
    lightGameObject->SetValue<uint64>("LightComponent", lightComponentId);
    ...
    screenObject->SetStringValue("GameObjectIds", gameObjectIds);
...
HRESULT CContentStudioDoc::ReadPropertiesFromConfiguration(CoreServices::ConfigurationPtr spConfiguration)
{
    ...
    tempValue = spConfiguration->GetStringValue(ContentRepositoryRootProperty);
    _documentProperties->SetString(ContentRepositoryRootProperty, (LPSTR)tempValue.c_str());
