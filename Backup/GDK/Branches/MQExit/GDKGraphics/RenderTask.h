...
namespace Lucid3D
{
    ...
    {
        TaskType::Enum Type;
        Lucid3D::Matrix Matrix;
        GeometryPtr Geometry;
        MaterialPtr Material;

        RenderTask(_In_ const Lucid3D::Matrix& matrix, _In_ GeometryPtr& geometry, _In_ MaterialPtr& material, _In_ ShaderPtr& shader)
    ...
    struct LightRenderTask : public RenderTask
    {
        ...
        LightRenderTask(_In_ const Lucid3D::Matrix& matrix, _In_ GeometryPtr& geometry, _In_ MaterialPtr& material, _In_ ShaderPtr& shader, _In_ LightComponent* light)
