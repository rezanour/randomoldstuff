...
// IObjectComponent
GDK_METHODIMP_(const GDK::IGameObject*) StaticMeshVisualComponent::GetOwner() const
{
    return _pOwner;
}

GDK_METHODIMP_(GDK::ObjectComponentType) StaticMeshVisualComponent::GetType() const
{
    return ObjectComponentType::VisualComponent;
}

GDK_METHODIMP StaticMeshVisualComponent::Process(_Inout_ RenderMap& renderMap)
{
    Transform transform;
