...
// IContentTag
GDK_METHODIMP_(ContentType::Enum) ContentTag::GetType() const
{
    return _contentType;
}

GDK_METHODIMP_(ObjectType::Enum)     ContentTag::GetObjectType() const
{
...
GDK_METHODIMP_(ComponentType::Enum)  ContentTag::GetComponentType() const
{
...
GDK_METHODIMP_(AssetType::Enum)      ContentTag::GetAssetType() const
{
...
GDK_METHODIMP_(ResourceType::Enum)   ContentTag::GetResourceType() const
{
...
GDK_METHODIMP_(uint64) ContentTag::GetID() const
{
    return _id;
}

GDK_METHODIMP_(const char* const) ContentTag::GetName() const
{
    return _name.c_str();
}
