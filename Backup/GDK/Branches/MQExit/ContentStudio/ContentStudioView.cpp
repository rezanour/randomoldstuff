...
void CContentStudioView::OnToolsRunGame()
{
    ...
    {
        quotediniFilePath = L"\"" + iniFilePath + L"\"";
        ...
        if (!CreateProcess(L"GDKGame.exe", (LPWSTR)quotediniFilePath.c_str(), nullptr, nullptr, false, creationFlags, nullptr, contentStudioDir.c_str(), &si, &pi))
        {
