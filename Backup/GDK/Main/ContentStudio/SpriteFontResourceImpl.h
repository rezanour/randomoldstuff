...
public:
    ...
    HRESULT GetNumGlyphs(_Out_ size_t* pnumGlyphs);
    HRESULT GetGlyphRects(_In_ size_t numGlyphRects, _In_ RECT* pGlyphRects);
    HRESULT GetGlyphs(_In_ size_t numGlyphs, _Out_ CHAR* pGlyphs);
    HRESULT GetFontName(_In_ size_t cchName, _Out_ WCHAR* pName);
