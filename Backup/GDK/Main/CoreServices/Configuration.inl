...
namespace CoreServices
{
    ...
    template <>
    inline Lucid3D::Vector2 Configuration::GetValue(_In_ const std::string& name, _In_ const Lucid3D::Vector2& defaultValue) const
    {
        std::istringstream ss(GetStringValue(name));
        Lucid3D::Vector2 value;
    ...
    template <>
    inline Lucid3D::Vector3 Configuration::GetValue(_In_ const std::string& name, _In_ const Lucid3D::Vector3& defaultValue) const
    {
        std::istringstream ss(GetStringValue(name));
        Lucid3D::Vector3 value;
    ...
    template <>
    inline Lucid3D::Vector4 Configuration::GetValue(_In_ const std::string& name, _In_ const Lucid3D::Vector4& defaultValue) const
    {
        std::istringstream ss(GetStringValue(name));
        Lucid3D::Vector4 value;
    ...
    template <>
    inline void Configuration::SetValue(_In_ const std::string& name, _In_ const Lucid3D::Vector2& value)
    {
        std::ostringstream ss;
        __storeFloats(ss, 2, &value.x);
        SetStringValue(name, ss.str());
    ...
    template <>
    inline void Configuration::SetValue(_In_ const std::string& name, _In_ const Lucid3D::Vector3& value)
    {
        std::ostringstream ss;
        __storeFloats(ss, 3, &value.x);
        SetStringValue(name, ss.str());
    ...
    template <>
    inline void Configuration::SetValue(_In_ const std::string& name, _In_ const Lucid3D::Vector4& value)
    {
        std::ostringstream ss;
        __storeFloats(ss, 4, &value.x);
        SetStringValue(name, ss.str());
