// NOTE: These GDKGraphics-specific serializers need a better home outside of ContentStudio
#pragma once
...
// The namespace is GDKGraphics, because this is not actually part of CoreServices. It's specific to our graphics plugin only
namespace GDKGraphics
{
    class GeometryData
    {
    public:
