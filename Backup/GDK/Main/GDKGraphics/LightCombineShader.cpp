...
GDK_IMETHODIMP LightCombineShader::Initialize(_In_ Renderer* pRenderer)
{
    HRESULT hr = S_OK;
...
GDK_IMETHODIMP LightCombineShader::RenderBatch(_In_ ContextPtr& spContext, _In_ CameraPtr& spCamera, _In_ std::vector<RenderTaskPtr>& renderTasks)
{
    HRESULT hr = S_OK;
