...
#include "Geometry.h"
#include "Renderer.h"
#include <CoreServices\GDKGraphicsSerializers.h>
...
GDK_IMETHODIMP Geometry::OnLoad(_In_ Renderer* pRenderer, _In_ IContentManagerPtr spContentManager, _In_ uint64 contentId)
{
    HRESULT hr = S_OK;
    ...
    else
    {
        ...
        CHECKHR(GDKGraphics::GeometryData::Load2(spStream, &vertexStride, &numVertices, vertices, indices));
...
GDK_IMETHODIMP Geometry::OnUnload()
{
    // Release resources
