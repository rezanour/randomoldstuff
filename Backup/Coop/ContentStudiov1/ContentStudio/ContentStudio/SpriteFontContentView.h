...
class CSpriteFontContentView : public IContentView
{
public:
    CSpriteFontContentView();
    virtual ~CSpriteFontContentView();
...
private:
    HRESULT PrepareSpriteFontContentForRendering(ISpriteFontContentPtr pSpriteFontContent);
