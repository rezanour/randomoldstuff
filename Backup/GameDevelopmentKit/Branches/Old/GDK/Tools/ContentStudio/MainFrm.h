...
public:
    ...
    virtual ~MainFrame();    
    ArchiveExplorerContentPreviewPane* GetArchivePreviewRenderingPane() { return &_archivePreviewRenderingPane; }
    ArchiveExplorerPane* GetArchivePane() { return &_archivePane; }
...
private:
    void TestRun(_In_ IGameFactory* gameFactory);
...
protected:
    ...
    ArchiveExplorerPane _archivePane;
    OutputPane          _outputPane;
    PropertiesPane      _propertiesPane;
    CMFCPopupMenu       _rendersMenu;
    ArchiveExplorerContentPreviewPane       _archivePreviewRenderingPane;
