...
class ArchiveExplorerPaneToolBar : public CMFCToolBar
{
...
class ArchiveExplorerPane : public CDockablePane
{
public:
    ArchiveExplorerPane();
    ...
    bool GetSelectedContent(_Out_ std::wstring& content);

protected:
    TreeControl _archivePane;
    CImageList _archiveExplorerImages;
    ArchiveExplorerPaneToolBar _toolBar;
    HTREEITEM _rootItem;
    HTREEITEM _gameItem;
...
private:
    HTREEITEM GetItemByName(_In_ HTREEITEM item, _In_ PCWSTR name);
