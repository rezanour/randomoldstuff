...
int ContentPane::OnCreate(_In_ LPCREATESTRUCT lpCreateStruct)
{
...
void ContentPane::OnSize(_In_ UINT nType, _In_ int cx, _In_ int cy)
{
    CDockablePane::OnSize(nType, cx, cy);
    AdjustLayout();
}

void ContentPane::SetArchiveName(_In_ PCWSTR archiveName)
{
    if (archiveName)
    {
...
void ContentPane::OnContextMenu(_In_ CWnd* pWnd, _In_ CPoint point)
{
...
void ContentPane::OnImport()
{
    AfxMessageBox(_T("Import...."));
}

void ContentPane::OnFileOpen()
{
    // TODO: Add your command handler code here
}

void ContentPane::OnFileOpenWith()
{
    // TODO: Add your command handler code here
}

void ContentPane::OnDummyCompile()
{
    // TODO: Add your command handler code here
}

void ContentPane::OnEditCut()
{
    // TODO: Add your command handler code here
}

void ContentPane::OnEditCopy()
{
    // TODO: Add your command handler code here
}

void ContentPane::OnEditClear()
{
    // TODO: Add your command handler code here
}
...
void ContentPane::OnSetFocus(_In_ CWnd* pOldWnd)
{
...
bool ContentPane::GetSelectedContent(_Out_ std::wstring& content)
{
...
void ContentPane::OnDeleteItem(_In_ HTREEITEM selectedItem)
{
    UNREFERENCED_PARAMETER(selectedItem);
}

int ContentPane::ResourceObjectTypeToImageIndex(_In_ PCWSTR resource)
{
    if (!resource)
    {
...
void ContentPane::OnDoubleClickedItem(_In_ HTREEITEM item)
{
